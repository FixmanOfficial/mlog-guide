 ...
 * ставят на карту в обычной игре; мировой живёт только в редакторе карт и умеет то, чего
 * обычный не умеет вовсе. Одним списком их держать нельзя: играющему обычную игру половина курса
