 ...
 *
 * Кинжал стоит ближе, флара дальше; здоровья у кинжала больше. Поэтому «ближний» и «самый
 ...
 *
 * Радар находит флару, турель её добивает — и ещё какое-то время радар продолжает отдавать
