...
/**
 * Урок «Draw Flush»: команд больше, чем помещается в буфер процессора.
 *
 * Процессор здесь гиперпроцессор — не ради красоты: на микропроцессоре триста клеток
 * рисовались бы четверть минуты, и урок про предел буфера стал бы уроком про ожидание.
 */
