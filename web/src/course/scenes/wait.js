 ...
 *
 * Числа, которые уроки называют вслух, проверяет `web/test/course.test.js`: сколько кругов
 * программа успевает за секунду с разными хвостами.
 */

/** Урок «Пауза в секундах»: круг раз в секунду вместо круга каждый такт. */
export const TICKS = {
 ...
 *
 * Четыре шага — это два круга: в круге две инструкции, а `после` так и остаётся пустым.
 */
export const ENDING = {
    width: 7, height: 5, floor: 'sand',
    blocks: [{type: 'micro-processor', x: 3, y: 2}],
